...
export const projects: Project[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    tagline: "An OBS-style recorder for games and anything else",
    accent: "#e2685f",
    glyph: "🎬",
    size: "md",
    description:
      "A desktop screen recorder in the spirit of OBS — capture your screen, a game, or any window and record it to video. Built for grabbing gameplay, but it'll record whatever you point it at.",
    highlights: [
      "Record your full screen, a specific game, or a single window",
      "Capture gameplay and desktop footage to video",
    ],
    tech: [],
    shots: [],
    links: [],
